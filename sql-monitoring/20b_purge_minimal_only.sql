-- ============================================================================
-- 20b_purge_minimal_only.sql  (purge-only, run in flask_minimal as SA)
-- Preserves items+customers, deletes everything else.
-- Run: sqlcmd -S "192.168.168.106,2436" -d "flask_minimal" -U "sa" -P 'Andrewplugg07606dev' -C -i /Users/tarun/workspace/personal/edi/sql-monitoring/20b_purge_minimal_only.sql
-- ============================================================================
SET NOCOUNT ON;
SET QUOTED_IDENTIFIER ON;
GO
PRINT '=== 20b_purge_minimal_only in ' + DB_NAME() + ' as ' + SUSER_SNAME() + ' ===';
GO

-- B5: Remove monitoring before purge (avoid audit flood)
